...
const fragmentShaderSource = `
      ...
      void main() {
        ...
        vec3 color = vec3(uv.x + sin(time), uv.y + cos(time), 0.5 + 0.5 * sin(time));
...
function render() {
    ...
    mat4.rotateX(modelViewMatrix, modelViewMatrix, deltaTime * 0.5);
    mat4.rotateY(modelViewMatrix, modelViewMatrix, deltaTime * 0.3);
    ...
    // Draw the sphere
    gl.drawArrays(gl.TRIANGLE_STRIP, 0, (latitudeBands + 1) * (longitudeBands + 1));
